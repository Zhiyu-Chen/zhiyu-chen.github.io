    ...
    return (
        <Section title="About Me" id="about">
            <p style={{ lineHeight: 1.8, fontSize: '1.1rem', marginBottom: '1.5rem' }}>
                My name is Zhiyu Chen (陈知雨). Now I am working as a senior applied scientist at Amazon in Seattle, US.
                My first name “Zhiyu” comes from an ancient Chinese poem (<a href="https://en.wikipedia.org/wiki/Du_Fu#Chengdu" target="_blank" rel="noopener noreferrer" style={{ color: 'var(--accent)' }}>好雨知时节</a>), which means good rain knows the best time to fall.
